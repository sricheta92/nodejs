...
var db_name = "test" ;
*/
//mongodb://<dbuser>:<dbpassword>@ds249123.mlab.com:49123/testgumball
var db_host = (process.env.mongodb_host || "ds249123.mlab.com" ) ;
var db_port = (process.env.mongodb_port || "49123" ) ;
var db_user = (process.env.mongodb_user || "cmpe281" ) ;
var db_pwd  = (process.env.mongodb_pwd  || "cmpe281" ) ;
var db_name = (process.env.mongodb_name || "testgumball" ) ;
